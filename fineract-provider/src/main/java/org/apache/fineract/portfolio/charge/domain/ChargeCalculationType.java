...
public enum ChargeCalculationType {
    ...
    FLAT_PERCENT_OF_AMOUNT(7,"chargeCalculationType.flat.percent.of.amount"),
    FLAT_PERCENT_OF_AMOUNT_AND_INTEREST(8, "chargeCalculationType.flat.percent.of.amount.and.interest"),
    FLAT_PERCENT_OF_INTEREST(9, "chargeCalculationType.flat.percent.of.interest");
    ...
    public static Object[] validValuesForLoan() {
        return new Integer[] { ChargeCalculationType.FLAT.getValue(), ChargeCalculationType.PERCENT_OF_AMOUNT.getValue(),
                ...
                ChargeCalculationType.FLAT_PERCENT_OF_AMOUNT.getValue(),
                ChargeCalculationType.FLAT_PERCENT_OF_AMOUNT_AND_INTEREST.getValue(),
                ChargeCalculationType.FLAT_PERCENT_OF_INTEREST.getValue() };
    }
    ...
    public static ChargeCalculationType fromInt(final Integer chargeCalculation) {
        ...
        switch (chargeCalculation) {
            ...
            break;
            case 7:
                chargeCalculationType = FLAT_PERCENT_OF_AMOUNT;
            break;
            case 8:
                chargeCalculationType = FLAT_PERCENT_OF_AMOUNT_AND_INTEREST;
            break;
            case 9:
                chargeCalculationType = FLAT_PERCENT_OF_INTEREST;
            break;
        }
    ...
    public boolean isFlatPercentageOfAmount() {
        return this.value.equals(ChargeCalculationType.FLAT_PERCENT_OF_AMOUNT.getValue());
    }
    ...
    public boolean isFlatPercentageOfAmountAndInterest() {
        return this.value.equals(ChargeCalculationType.FLAT_PERCENT_OF_AMOUNT_AND_INTEREST.getValue());
    }
    ...
    public boolean isFlatPercentageOfInterest() {
        return this.value.equals(ChargeCalculationType.FLAT_PERCENT_OF_INTEREST.getValue());
    }
    ...
    public boolean isPercentageBased() {
        return isPercentageOfAmount() || isPercentageOfAmountAndInterest() || isPercentageOfInterest() || isPercentageOfDisbursementAmount()
                || isFlatPercentageOfAmount() || isFlatPercentageOfAmountAndInterest() || isFlatPercentageOfInterest();
    }
